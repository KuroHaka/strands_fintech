...
async function GetAllUsers(){
    ...
    for(var i = 0; i < userIDS.length; i++){
        var t = JSON.parse(await GetUserInfo(userIDS[i]))
        console.log(t);
        res.push(t)
    }
